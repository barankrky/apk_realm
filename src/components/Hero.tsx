        ...
        <section className="bg-black text-white min-h-[50vh] flex items-center justify-center relative">
            ...
            <div className="container mx-auto px-4 z-10">
                <div className="flex flex-col items-center text-center space-y-8">
                    ...
                    <p className="text-lg md:text-xl max-w-2xl text-gray-300 leading-relaxed animate-fade-in" style={{ animationDelay: '0.1s' }}>
                        Android uygulamalarınızı farklı kaynaklardan indirmek ve yüklemek için
                        <span className="block animate-fade-in" style={{ animationDelay: '0.2s' }}>en güvenilir platformunuz</span>
                    </p>
